        ...
        <div className='container'>
            ...
            {/* brand info section */}
                <div className='py-8 px-4 space-y-4'>
                    ...
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta eveniet accusantium dolorem aliquid distinctio est fugit temporibus impedit quibusdam? Unde?
                    </p>
            ...
            <div className='mt-8'> 
                <div className='text-center py-6 border-t-2 border-gray-300/10'>
                    <span className='text-sm text-gray-300 opacity-70'>
                        @copright 2024 The Coding Journey
                    </span>
                </div>
            </div>
        </div>
